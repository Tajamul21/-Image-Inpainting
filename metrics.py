...
img = cv2.imread("S:\IIT DELHI (MSR)\\1st_Semester\COL783 -Digital Image Analysis\Assignements\Assignment3\\final.png",0)
pred = cv2.imread("S:\IIT DELHI (MSR)\\1st_Semester\COL783 -Digital Image Analysis\Assignements\Assignment3\\final.png", 0)
cv2.imshow("a",img)
cv2.waitKey(0)
